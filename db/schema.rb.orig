...
<<<<<<< HEAD
ActiveRecord::Schema[7.2].define(version: 20_260_310_163_512) do
...
<<<<<<< HEAD
  ...
  create_table 'people', force: :cascade do |t|
    ...
    t.index %w[resource_type resource_id role], name: 'index_people_on_resource_type_and_resource_id_and_role'
    t.index %w[resource_type resource_id], name: 'index_people_on_resource'
  end
